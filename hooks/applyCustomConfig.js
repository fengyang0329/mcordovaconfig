...
var applyCustomConfig = (function(){
    ...
    function getElements(elementName, pathPrefix){
        ...
        if(settings["parse_unprefixed"] === 'true' ||  settings["parse_unprefixed"] !== 'false'){
    ...
    function getPlatformPods(platform){

        if (!pods) {
              pods = {

                common: getElements('pods')
            };
        }
        //公用部分
    ...
    function parseConfigXml(platform) {
        ...
        //using <custom-pods> 
        parseiOSPods(configData,platform);
    ...
    function parseiOSPods(configData,platform){

        var _pods = getPlatformPods(platform);
        // console.log("*****pods:",_pods);
...
// console.log("***********env_init.js npm install**************")
...
console.log("currDir::",currDir);
    ...
    console.log("currDi3333r::",shell.pwd());
    ...
    shell.cd(currDir);
        ...
        console.log("currDi444r::",shell.pwd());


                // exec("pod install",{cmd:targetFilePath},function(err){
                ...
                // console.log('a ::::\n',a.last);
        // var result = content.parse('foo@bar$cool@xux$cool@yys','@','$','pod');

            // content = fileUtils.conte   
        }
    }
    /**
    ...
    applyCustomConfig.loadDependencies = function(ctx){
        fs = require('fs'),
            ...
            os = require('os')
            console.log("loadDependencies*****************",path.resolve(hooksPath, "fileUtils.js"))
